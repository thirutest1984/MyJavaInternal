...
/**
 * Creating a Inventory stock DAO class for the an Electronic items store
 * management.
 * 
...
public class InventoryStockDao {
	 ...
	 * @param itemPrice
	 */
	public InventoryStockDao(int productId, String productName, String makeAndModelName, int numberOfItems,
			double itemPrice) {
